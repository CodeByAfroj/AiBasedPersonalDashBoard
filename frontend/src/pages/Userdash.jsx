...
//         `http://localhost:3000/api/update/${editingData._id}`,
//         { title, desc, link },
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       setEditingData(null);
...
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       setData((prev) => [res.data, ...prev]); // add new entry to top
//       setTitle("");
//       setDesc("");
//       setLink("");
...
//         {showAddPopup && (
//           <div className="mt-4 p-4 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col gap-3">
//             <input
//               type="text"
//               value={title}
